...
const Register: React.FC = () => {
    ...
    useEffect(() => {
        const validateToken = async () => {
            if (token) {
                try {
                    const invite = await invitesApi.validate(token);
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex">
                        ...
                        <div className="ml-3">
                            <p className="text-sm text-yellow-700">
                                Registration requires an invitation link. If you don't have one, please contact an administrator.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            {/* Registration Form */}
            <div className={`card ${!token ? 'opacity-50 pointer-events-none' : ''}`}>
                <form className="space-y-5" onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`input ${isEmailLocked ? 'bg-gray-100 cursor-not-allowed' : ''}`}
                        />
                    </div>
